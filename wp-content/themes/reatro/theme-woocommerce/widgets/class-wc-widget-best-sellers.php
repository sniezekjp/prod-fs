...
class Twoot_Widget_Best_Sellers extends WP_Widget {
	...
	public function __construct() {
		...
		$this->widget_cssclass 		= 'woocommerce widget_best_sellers widget_products';
		$this->widget_description 	= __( 'Display a list of your best selling products on your site.', 'woocommerce' );
		$this->widget_id            = 'best_sellers';
		$this->widget_name 			= __( 'WooCommerce Best Sellers', 'woocommerce' );
