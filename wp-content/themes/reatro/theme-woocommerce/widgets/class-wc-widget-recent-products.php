...
class Twoot_Widget_Recent_Products extends WP_Widget {
	...
	public function __construct() {
		...
		$this->widget_cssclass 		= 'woocommerce widget_recent_products widget_products';
		$this->widget_description 	= __( 'Display a list of your most recent products on your site.', 'woocommerce' );
		$this->widget_id            = 'recent_products';
		$this->widget_name 			= __( 'WooCommerce Recent Products', 'woocommerce' );
