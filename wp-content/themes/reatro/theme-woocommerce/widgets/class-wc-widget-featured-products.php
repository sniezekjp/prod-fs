...
class Twoot_Widget_Featured_Products extends WP_Widget {
	...
	public function __construct() {
		...
		$this->widget_cssclass 		= 'woocommerce widget_featured_products widget_products';
		$this->widget_description 	= __( 'Display a list of featured products on your site.', 'woocommerce' );
		$this->widget_id            = 'featured-products';
		$this->widget_name 			= __( 'WooCommerce Featured Products', 'woocommerce' );
