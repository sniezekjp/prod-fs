...
class Twoot_Widget_Onsale extends WP_Widget {
	...
	public function __construct() {
		...
		$this->widget_cssclass 		= 'woocommerce widget_onsale widget_products';
		$this->widget_description 	= __( 'Display a list of your on-sale products on your site.', 'woocommerce' );
		$this->widget_id            = 'onsale';
		$this->widget_name 			= __( 'WooCommerce On-sale', 'woocommerce' );
