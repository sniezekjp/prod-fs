...
class Twoot_Widget_Recently_Viewed extends WP_Widget {
	...
	public function __construct() {
		...
		$this->widget_cssclass 		= 'woocommerce widget_recently_viewed_products widget_products';
		$this->widget_description 	= __( 'Display a list of recently viewed products.', 'woocommerce' );
		$this->widget_id            = 'recently_viewed_products';
		$this->widget_name 			= __( 'WooCommerce Recently Viewed Products', 'woocommerce' );
